    ...
    public function toArray($request)
    {
        return [
            ...
            'kelas' => [
                ...
                'ruang' => $this->when((isset($this->ruang) && ($request->routeIs('kelas.index') == false)), $this->ruang),
                'walikelas' => $this->when((isset($this->walikelas) && ($request->routeIs('kelas.index') == false)), $this->walikelas),
